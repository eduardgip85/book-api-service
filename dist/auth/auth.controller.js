...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registra un nou usuari' }),
    (0, swagger_1.ApiBody)({ type: auth_dto_1.RegisterUserDto }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Usuari registrat correctament' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: "Nom d'usuari ja existent" }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Inicia sessió i obté un JWT' }),
    (0, swagger_1.ApiBody)({ type: auth_dto_1.LoginUserDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Login correcte',
        schema: {
            example: { access_token: 'eyJhbGciOiJIUzI1Ni...' },
        },
    }),
